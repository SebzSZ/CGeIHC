...
void MeshLines::CreateMeshLines(GLfloat* vertices, unsigned int numOfVertices)
{
	vertexCount = numOfVertices;
	glGenVertexArrays(1, &VAO);
	glBindVertexArray(VAO);
...
void MeshLines::RenderMeshLines()
{
	glBindVertexArray(VAO);
...
void MeshLines::RenderMeshTriangles()
{
	glBindVertexArray(VAO);
	glDrawArrays(GL_TRIANGLES, 0, vertexCount);
	glBindVertexArray(0);
